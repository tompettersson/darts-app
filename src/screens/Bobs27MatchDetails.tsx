      ...
      <div style={styles.centerPage}>
        <div style={{ ...styles.centerInner, maxWidth: 500 }}>
          ...
          <div style={{ ...styles.card, marginBottom: 16, textAlign: 'center' }}>
            <div style={{ fontSize: 12, color: colors.fgMuted, marginBottom: 4 }}>
              {new Date(storedMatch.createdAt).toLocaleDateString('de-DE', { day: '2-digit', month: '2-digit', year: 'numeric' })}
            </div>
