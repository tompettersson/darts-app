...
import { getCTFMatchById, setCTFMatchMetadata } from '../storage'
...
export default function CTFSummary({ matchId, onBackToMenu, onRematch, onBackToLobby, isMultiplayerGuest }: Props) {
  ...
  const handleSaveMetadata = () => {
    const success = setCTFMatchMetadata(matchId, endscreenName, endscreenNotes)
