...
import { getStrMatchById, setStrMatchMetadata } from '../storage'
import {
  applyStrEvents,
  formatDuration,
...
export default function StraeusschenSummary({ matchId, onBackToMenu, onRematch, onBackToLobby, isMultiplayerGuest }: Props) {
  ...
  const handleSaveMetadata = () => {
    const success = setStrMatchMetadata(matchId, endscreenName, endscreenNotes)
