...
export default function Bobs27Summary({ matchId, onBackToMenu, onRematch, onBackToLobby, onOpenLegSummary, isMultiplayerGuest }: Props) {
  ...
  const handleSaveMetadata = () => {
    const success = setBobs27MatchMetadata(matchId, endscreenName, endscreenNotes)
    ...
    <div style={styles.page}>
      ...
      <div style={styles.centerPage}>
        <div style={{ ...styles.centerInner, maxWidth: isMobile ? '100%' : 500, padding: isMobile ? '0 4px' : undefined }}>
          ...
          {/* Spieler-Statistiken (Vergleichstabelle) — nur bei Single-Leg-Matches,
              da sonst nur das letzte Leg dargestellt würde (Engine-State resettet pro Leg).
              Bei Mehrleg-Matches übernimmt das Match-Aggregat + Leg-Liste diese Rolle. */}
          {!isMultiLeg && (() => {
          ...
          {/* Target-Timeline — aus demselben Grund nur bei Single-Leg. */}
          {!isMultiLeg && rankings.map((p, pi) => {
