...
type Props = {
  ...
  large?: boolean  // Tablet: bigger buttons
}
...
export default function MobileScoreInput({ onThrow, dartsThrown = 0, thrownDarts = [], onUndoLastDart, onUndoLastVisit, large }: Props) {
